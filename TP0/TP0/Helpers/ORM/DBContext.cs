...
namespace TP0.Helpers.ORM
{
    ...
    public class DBContext : DbContext
    {
        ...
        //public DBContext() : base(@"Data Source=tcp:tpdds2018avengersdbserver.database.windows.net,1433;Initial Catalog=DBdisenio;User ID=sqladmin@tpdds2018avengersdbserver;Password=lalala231,.")
        {
        }
    }
}